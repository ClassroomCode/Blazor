<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PropGen1.aspx.cs" Inherits="WebForms.PropGen1" %>
                    ...
                    <td align="center" bgcolor="#eff3fb">
                      <table style="font-size: 10pt; font-family: Verdana; width: 100%">
                        ...
                        <tr>
                          ...
                          <td align="left">
                            <div>
                              <asp:DropDownList ID="CurrencyList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="CurrencyList_SelectedIndexChanged"></asp:DropDownList>&nbsp;<asp:Label ID="CurrencyRateLabel" runat="server" Text=""></asp:Label>
                            </div>
                          </td>
                        </tr>
                      </table>
